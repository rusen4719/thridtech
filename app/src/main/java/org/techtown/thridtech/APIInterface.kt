...
data class SearchFriends(@SerializedName("data") val data : JsonArray? = null,
                      @SerializedName("msg") val msg : String? = null)

data class AddFriends(@SerializedName("data") val data : JsonPrimitive? = null,
                         @SerializedName("msg") val msg : String? = null)

data class ChangeProfile(@SerializedName("data") val data : JsonObject? = null,
                      @SerializedName("msg") val msg : String? = null)

data class UploadImg(@SerializedName("data") val data : JsonPrimitive? = null,
                         @SerializedName("msg") val msg : String? = null)
...
interface APIInterface {
    ...
    fun uploadImg1(@Part url: MultipartBody.Part): Call<UploadImg>

    @POST("/api/user/upload")
    fun uploadImg(@Body jsonObj: JsonObject): Call<UploadImg>
